;
(function (angular) {
  angular.module('disasterRec').directive('page', pageDirective);
    ...
    return {
      ...
      controller: ['$scope', '$attrs', '$parse', function ($scope, $attrs, $parse) {
        ...
        this.calculateTotalPages = function () {
          if ($scope.totalCount === null || $scope.totalCount === undefined) {
            $scope.totalCount = 0;
          }
          return Math.ceil($scope.totalCount / this.pageCount) === 0 ? 1 : Math.ceil($scope.totalCount / this.pageCount);
        };
